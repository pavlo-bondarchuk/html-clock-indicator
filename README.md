...
- Decimal logic: first separator (between hours & minutes) off, second shows `sep-d.webp` if a fractional part exists; for 3+ integer digits (e.g. 100.x) the fraction is dropped.
...
html-clock-indicator/
  ...
  img/clock/            # Digits 0-9, units (cel.webp, far.webp), separators
  n0.webp .. n9.webp
  sep-c.webp      # Colon
  sep-d.webp        # Decimal dot (temperature)
  sep-e.webp          # Empty separator
  cel.webp        # °C indicator
  far.webp      # °F indicator
    font/                 # UI webfont
  locales/
...
- `sep-d.webp` used solely as the decimal point in the second separator.
